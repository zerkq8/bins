...
function normOpen(t = {}) {
   ...
   * `isolatedWallet` هو المبلغ الفعلي الذي خصّصه المتداول لهذا المركز
   * تحديداً، **لكن فقط في وضع "Isolated"**. في وضع "Cross" (الأكثر
   * شيوعاً) لا يوجد هامش مخصص لكل مركز — رأس المال مشترك بين كل
   * المراكز المفتوحة معاً، فهذا الحقل يكون صفراً وغير ذي معنى هناك.
  ...
  return {
    ...
    pnl,
    roi,
    notional,                 // حجم المركز الكامل (مُعلَن أو مُحسوب)
    marginReported,           // الهامش الحقيقي من باينس — null إن كان Cross
