 ...
 * أياً كان حجمها.
 * وحتى مع عتبة نسبية، عيّنة صغيرة جداً (مثلاً ٣) تجعل "٢ من ٣" اتفاقاً
 * سهل الحدوث بالصدفة (عملة مشهورة كـBTC/ETH يدخلها كثيرون أصلاً بلا أي
 * توافق حقيقي) — لذا حد أدنى مطلق ABS_MIN_ELITE يمنع أي فحص توافق
 * إطلاقاً بعيّنة أصغر منه، بغض النظر عن النسبة.
 */
const ABS_MIN_ELITE = 5;         // لا فحص توافق إطلاقاً بعيّنة أصغر من هذا
